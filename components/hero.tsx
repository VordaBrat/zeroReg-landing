  ...
  return (
    <section className="min-h-screen flex flex-col justify-center items-center text-center px-6 pt-32 pb-16 max-w-4xl mx-auto">
      ...
      <p className="text-lg text-text-muted max-w-md mb-10 leading-relaxed">
        Meet <strong className="text-text font-semibold">zeroReg</strong> — write regex without{" "}
        <em className="italic font-semibold text-text underline decoration-wavy decoration-red decoration-2 underline-offset-4">tears</em> or{" "}
        <em className="italic font-semibold text-text underline decoration-wavy decoration-red decoration-2 underline-offset-4">confusion</em>.
      </p>
      ...
      <div className="flex items-center justify-center gap-6 flex-wrap">
        <span className="text-text-muted text-sm">~3kb gzipped</span>
        <span className="text-text-muted text-sm before:content-[''] before:w-1 before:h-1 before:bg-zinc-700 before:rounded-full before:inline-block before:mr-6">Zero dependencies</span>
        <span className="text-text-muted text-sm before:content-[''] before:w-1 before:h-1 before:bg-zinc-700 before:rounded-full before:inline-block before:mr-6">Fully typed</span>
      </div>
    </section>
  );
}